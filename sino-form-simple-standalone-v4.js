(function () {
  ...
  for (const j of document.querySelectorAll('link[rel="modulepreload"]')) w(j);
  new MutationObserver((j) => {
    for (const C of j)
      if (C.type === 'childList')
        for (const N of C.addedNodes) N.tagName === 'LINK' && N.rel === 'modulepreload' && w(N);
  }).observe(document, { childList: !0, subtree: !0 });
  function a(j) {
    const C = {};
    return (
      j.integrity && (C.integrity = j.integrity),
      j.referrerPolicy && (C.referrerPolicy = j.referrerPolicy),
...
function sm() {
  ...
  var l = rl(),
    ...
    j = l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
  ...
  function N(m, h, z) {
    ...
    if (m && m.defaultProps) for (K in ((h = m.defaultProps), h)) O[K] === void 0 && (O[K] = h[K]);
    return { $$typeof: c, type: m, key: b, ref: Z, props: O, _owner: j.current };
  }
  return ((Ht.Fragment = a), (Ht.jsx = N), (Ht.jsxs = N), Ht);
}
var $u;
function om() {
  return ($u || (($u = 1), (Ko.exports = sm())), Ko.exports);
}
var r = om(),
  W = rl(),
  ss = {},
    ...
    qu ||
      ...
      (function (l) {
            ...
            e: for (var f = 0, S = F.length, G = S >>> 1; f < G; ) {
              ...
              if (0 > j(se, A))
                le < S && 0 > j(ge, se)
                  ? ((F[f] = ge), (F[le] = A), (f = le))
                  : ((F[f] = se), (F[ie] = A), (f = ie));
              else if (le < S && 0 > j(ge, A)) ((F[f] = ge), (F[le] = A), (f = le));
              else break e;
            }
          }
          return V;
        ...
        function ue(F, V) {
          ...
          var A = b;
          try {
            for (me(V), O = a(h); O !== null && (!(O.expirationTime > V) || (F && !cn())); ) {
              var f = O.callback;
...
function um() {
  ...
  function N(e, n) {
    for (j[e] = n, e = 0; e < n.length; e++) w.add(n[e]);
  }
  var m = !(
      typeof window > 'u' ||
...
` + s[u].replace(' at new ', ' at ');
  ...
  function rr(e, n) {
    ...
    if (u !== 0) {
      var d = u & ~s;
      d !== 0 ? (t = pt(d)) : ((o &= u), o !== 0 && (t = pt(o)));
    } else ((u = i & ~s), u !== 0 ? (t = pt(u)) : o !== 0 && (t = pt(o)));
    if (t === 0) return 0;
    if (
      n !== 0 &&
      n !== t &&
  ...
  function ia(e, n) {
    ...
    if (Jt) throw ((e = ms), (Jt = !1), (ms = null), e);
  }
  function Ne(e, n) {
    var i = n[$s];
    ...
    switch (e.tag) {
      case 5:
        ...
        return (
          ...
          n !== null ? ((e.stateNode = n), (mn = e), (pn = Jn(n.firstChild)), !0) : !1
        );
      case 6:
        return (
  ...
  function Qs(e) {
    if (ke) {
      ...
      if (n) {
        ...
        if (Ks(e)) throw Error(a(418));
        ((e.flags = (e.flags & -4097) | 2), (ke = !1), (mn = e));
      }
    }
  }
  function ha(e) {
...
` +
    ...
    if ((Qi(n, s), n.stateNode === null)) (Vr(e, n), Ga(n, i, t), vo(n, i, t, s), (t = !0));
      ...
      d !== R || T !== $ || rn.current || ti
        ? (typeof B == 'function' && (go(n, i, B, t), ($ = n.memoizedState)),
          (x = ti || Ha(n, i, x, t, T, $, p) || !1)
            ? (E ||
                (typeof u.UNSAFE_componentWillUpdate != 'function' &&
                  typeof u.componentWillUpdate != 'function') ||
                (typeof u.componentWillUpdate == 'function' && u.componentWillUpdate(t, $, p),
                typeof u.UNSAFE_componentWillUpdate == 'function' &&
                  u.UNSAFE_componentWillUpdate(t, $, p)),
          ...
          if (!t.hasOwnProperty(x) && s.hasOwnProperty(x) && s[x] != null)
            if (x === 'style') {
              ...
              x !== 'dangerouslySetInnerHTML' &&
                ...
                x !== 'autoFocus' &&
                (j.hasOwnProperty(x) ? o || (o = []) : (o = o || []).push(x, null));
        for (x in t) {
          var p = t[x];
          if (
            ((d = s != null ? s[x] : void 0),
                ...
                u === 'children'
                  ? typeof d == 'string'
                    ...
                    : typeof d == 'number' &&
                      ...
                      (o.suppressHydrationWarning !== !0 && yr(t.textContent, d, e),
                      (s = ['children', '' + d]))
                  : j.hasOwnProperty(u) && d != null && u === 'onScroll' && Ne('scroll', t);
              }
            switch (i) {
              case 'input':
                (Ti(t), ot(t, o, !0));
        ...
        e: {
          ...
          if (((t = u.element), o.isDehydrated))
            if (
              ...
              for (
                pn = Jn(n.stateNode.containerInfo.firstChild),
                  mn = n,
                  ke = !0,
                  kn = null,
                  i = _a(n, null, t, i),
  ...
  if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < 'u') {
    ...
    if (!rs.isDisabled && rs.supportsFiber)
      try {
        ((nr = rs.inject(im)), (Rn = rs));
      } catch {}
  }
  return (
    (un.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = nm),
...
const pm = {
  ...
  fm = ({ children: l }) => {
    const [c, a] = W.useState(pm),
      w = W.useCallback((C) => {
        const { name: N, value: m, type: h } = C.target,
          z = C.target.checked;
        a((K) => ({ ...K, [N]: h === 'checkbox' ? z : m }));
      }, []),
      j = { formData: c, setFormData: a, handleInputChange: w };
    return r.jsx(nc.Provider, { value: j, children: l });
  };
function hm() {
            ...
            children: [
              ...
              r.jsxs(
                'button',
                {
                  ...
                  onKeyDown: (z) => {
                    (z.key === 'Enter' || z.key === ' ') && (z.preventDefault(), m(h.key));
                  },
                  children: [
                    r.jsx('span', {
  ...
  for (const N of a)
    if (
      ...
      if (m && typeof m == 'object' && !Array.isArray(m)) {
        ...
        for (const [, z] of h) (j++, os(z) && w++);
        h.length;
      }
    } else if (N === 'totalWeight') (j++, os(c.totalWeight) && w++);
    else {
      j++;
      const m = c[N];
      os(m) && w++;
    }
  const C = j > 0 ? Math.round((w / j) * 100) : 0;
  return { filled: w, total: j, percentage: C };
}
function ym(l, c) {
  switch (l) {
    case 'services':
...
const nl = ({ stepId: l, formData: c, currentStepIndex: a, totalSteps: w, t: j }) => {
    const C = ic(l, c),
      N = ym(l, j);
      ...
      : r.jsxs('div', {
          ...
          children: [
            r.jsxs('div', {
              ...
              children: [
                r.jsx('span', { className: 'sino-simple-form__step-progress-label', children: N }),
                r.jsxs('span', {
                  className: 'sino-simple-form__step-progress-count',
                  children: [C.filled, '/', C.total, ' ', j('stepProgressFields', 'fields')],
                }),
              ],
            }),
            r.jsx('div', {
              ...
              children: r.jsx('div', {
                ...
                'aria-valuemin': 0,
                'aria-valuemax': 100,
                'aria-label': `${N}: ${C.filled} of ${C.total} fields completed`,
              }),
            }),
          ],
        });
    ...
    r.jsxs('section', {
      ...
      children: [
        ...
        r.jsxs('div', {
          ...
          children: [
            r.jsxs('div', {
              className: `sino-simple-form__field${m.firstName && N.firstName ? ' sino-simple-form__field--error' : ''}${m.firstName && !N.firstName && w(l.firstName) ? ' sino-simple-form__field--success' : ''}`,
              children: [
                r.jsxs('label', {
                  className: 'sino-simple-form__label',
                  htmlFor: 'firstName',
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx('input', {
                      className: `sino-simple-form__input${N.firstName ? ' sino-simple-form__input--error' : ''}${m.firstName && !N.firstName && w(l.firstName) ? ' sino-simple-form__input--success' : ''}`,
                      type: 'text',
                      name: 'firstName',
                      id: 'firstName',
                      ref: h,
                      ...
                      'aria-describedby': N.firstName
                        ? 'firstName-error'
                        : m.firstName && !N.firstName && w(l.firstName)
                          ? 'firstName-success'
                          : void 0,
                      'aria-invalid': N.firstName ? 'true' : 'false',
                      'aria-required': 'true',
                    }),
                    m.firstName &&
                      r.jsxs(r.Fragment, {
            ...
            r.jsxs('div', {
              className: `sino-simple-form__field${m.email && N.email ? ' sino-simple-form__field--error' : ''}${m.email && !N.email && w(l.email) ? ' sino-simple-form__field--success' : ''}`,
              children: [
                r.jsxs('label', {
                  className: 'sino-simple-form__label',
                  htmlFor: 'email',
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx('input', {
                      className: `sino-simple-form__input${N.email ? ' sino-simple-form__input--error' : ''}${m.email && !N.email && w(l.email) ? ' sino-simple-form__input--success' : ''}`,
                      type: 'email',
                      name: 'email',
                      id: 'email',
                      ref: z,
                      ...
                      'aria-describedby': N.email
                        ? 'email-error'
                        : m.email && !N.email && w(l.email)
                          ? 'email-success'
                          : void 0,
                      'aria-invalid': N.email ? 'true' : 'false',
                      'aria-required': 'true',
                    }),
                    m.email &&
                      r.jsxs(r.Fragment, {
            ...
            r.jsxs('div', {
              className: `sino-simple-form__field${m.phone && N.phone ? ' sino-simple-form__field--error' : ''}${m.phone && !N.phone && w(l.phone) ? ' sino-simple-form__field--success' : ''}`,
              children: [
                r.jsxs('label', {
                  className: 'sino-simple-form__label',
                  htmlFor: 'phone',
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    r.jsx('input', {
                      className: `sino-simple-form__input${N.phone ? ' sino-simple-form__input--error' : ''}${m.phone && !N.phone && w(l.phone) ? ' sino-simple-form__input--success' : ''}`,
                      type: 'tel',
                      name: 'phone',
                      id: 'phone',
                      ref: K,
                      ...
                      'aria-describedby': N.phone
                        ? 'phone-error'
                        : m.phone && !N.phone && w(l.phone)
                          ? 'phone-success'
                          : void 0,
                      'aria-invalid': N.phone ? 'true' : 'false',
                      'aria-required': 'true',
                    }),
                    m.phone &&
                      r.jsxs(r.Fragment, {
...
function km(l) {
  ...
  a && (c.country = a.name);
  const j = [...wm, ...Nm, ...jm].find((Z) => Z.code === l.origin);
  j && (c.origin = j.name);
  const C = new Date(),
    N = C.toLocaleDateString('en-CA', { timeZone: 'Asia/Hong_Kong' }),
  ...
  const b = {
    ...
    shippingRoute: {
      ...
      originPortOfLoading: j ? j.name : c.origin,
      shippingMode: c.mode,
      incoterm: c.incoterm,
    },
    shippingCargo: {
...
async function Sm(l, c) {
  ...
  try {
    ...
    if (!C.ok) {
      ...
      const m = C.status;
      console.error('[submitFormData] Webhook failed:', m, N);
      const h = `We could not send your quote request (status ${m}). Please try again in a few minutes or contact us directly.`;
      throw (c && c(h), new Error(h));
    }
    return (
      console.log('[submitFormData] Webhook succeeded:', C.status),
...
function tc(l) {
  ...
  const w = (j = c.split('@')[1]) == null ? void 0 : j.toLowerCase();
  if (w) {
    const C = {
      'gmial.com': 'gmail.com',
      'gmai.com': 'gmail.com',
...
function il(l) {
  ...
  return c.length === 0
    ...
    : /^[A-Z]{2,3}$/i.test(c)
      ? Qt.find((j) => j.code.toUpperCase() === c.toUpperCase())
        ? { valid: !0 }
...
const Pm = [
  ...
  Lm = ({ formData: l, t: c, selectedServiceLabels: a, orderedSteps: w, onEditStep: j }) => {
    var O;
    const C = (b) => {
        if (!b) return '';
              ...
              r.jsx('button', {
                ...
                onClick: async () => {
                  ...
                  try {
                    ...
                    const { submissionId: re, payload: ue } = km(l);
                    ...
                    if (
                      ...
                      (console.error('[SimpleFooterSection] Setting error message:', ue), j(ue));
                    }
                  } finally {
                    N(!1);
                  }
...
const Mm = ({ currentStepIndex: l, totalSteps: c, orderedSteps: a, formData: w, t: j }) => {
      ...
      children: [
        ...
        r.jsx('span', {
          ...
          children: C.isAlmostDone
            ? j('timeEstimateAlmostDone', C.message)
            : j('timeEstimateRemaining', C.message),
        }),
      ],
    });
  },
  Fm = ({
    ...
    r.jsxs('div', {
      ...
      children: [
        ...
        r.jsx(Mm, { currentStepIndex: l, totalSteps: c, orderedSteps: N, formData: m, t: h }),
        r.jsxs('div', {
  ...
  Yu = ({
    ...
    (W.useEffect(
      ...
      W.useEffect(() => {
        const f = (S) => {
          Ie.current && !Ie.current.contains(S.target) && (I(!1), me(-1));
        };
        if (P)
          return (
    ...
    const Te = (f) => {
      ...
      Re = (f) => {
        ((cn.current = !0), ue(f.label), I(!1), me(-1), N && N(f.value));
      ...
      H = (f) => {
        ...
        switch (f.key) {
          ...
          case 'Enter':
            ...
            break;
          case 'Escape':
            (f.preventDefault(), I(!1), me(-1), (S = O.current) == null || S.focus());
            break;
          case 'Tab':
            (I(!1), me(-1));
            break;
            ...
            children: V
              ...
              : X.map((f, S) =>
                  r.jsxs(
                    ...
                    {
                      id: `${l}-option-${S}`,
                      className: `sino-simple-form__autocomplete-option${pe === S ? ' sino-simple-form__autocomplete-option--highlighted' : ''}`,
                      role: 'option',
                      'aria-selected': pe === S,
                      onClick: () => Re(f),
                      onMouseEnter: () => me(S),
  ...
  zm = () => Qt.map((l) => ({ value: l.code, label: l.name, flag: l.flag })),
  Im = (l) => (Om[l] || []).map((a) => ({ value: a, label: a }));
function ls(l) {
...
function Wm(l, c, a) {
  ...
  const w = ls(l.length),
    j = ls(l.width),
    C = ls(l.height);
  if (!w || !j || !C) return { value: null, formatted: '' };
  const N = Jo(w),
    m = Jo(j),
    h = Jo(C),
    K = N * m * h * a,
...
function Am(l, c, a) {
  ...
  const j = w * a,
    C = c,
    N = j.toLocaleString('en-US', { maximumFractionDigits: 2, useGrouping: !0 });
  return { value: j, formatted: `${N} ${C}` };
}
function Vm(l) {
  const c = Wm(l.dimensions, 'CM', l.numberOfUnits),
    a = Am(l.weightPerUnit, 'KG', l.numberOfUnits);
...
const Bm = ({ formData: l, setFormData: c, t: a }) => {
    const w = W.useMemo(() => Vm(l), [l.dimensions, l.numberOfUnits, l.weightPerUnit]),
      j = w.totalVolume.value !== null || w.totalWeightFromUnits.value !== null,
      C = W.useRef(!1);
    return (
      W.useEffect(() => {
        if (w.totalWeightFromUnits.value !== null && !C.current) {
          const N = l.totalWeight,
            m = Math.round(w.totalWeightFromUnits.value).toString();
          if (!N || N.trim() === '') {
            C.current = !0;
            const h = setTimeout(() => {
              (c((z) =>
                !z.totalWeight || z.totalWeight.trim() === '' ? { ...z, totalWeight: m } : z
              ),
                (C.current = !1));
            }, 1e3);
            return () => {
  ...
  Um = ({ t: l }) => {
    ...
    W.useEffect(() => {
      ...
      try {
        window.localStorage.getItem(Zu) === 'true' && j(!0);
      } catch {}
      const N = setTimeout(() => {
        a(!0);
      }, 500);
    ...
    const C = () => {
      const N = !w;
      if ((j(N), typeof window < 'u'))
        try {
          window.localStorage.setItem(Zu, String(N));
        } catch {}
    };
    return r.jsx('div', {
  ...
  Gm = ({
    ...
    setShowChinaVisitLogistics: j,
    stepLabel: C,
  }) => {
    if (!l.servicesRequested.chinaVisits) return null;
    const N = l.chinaVisit.visitType,
      m = (P) => {
        c((I) => {
      ...
      h = N.includes('Canton Fair'),
      z = N.includes('Yiwu Market'),
      K = N.includes('Factory Visits'),
      O = N.includes('Other Trade Fair'),
      b = K || O,
      Z = N.length > 0,
      Y =
        h && !z && !K && !O
                      ...
                      children: [
                        ...
                        return r.jsx(
                          'button',
                          {
                            ...
                            'aria-pressed':
                              ((z = l.otherProject) == null ? void 0 : z.projectType) === m.value
                                ? 'true'
                                : 'false',
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    ...
                    r.jsx('textarea', {
                      ...
                      className: 'sino-simple-form__input sino-simple-form__input--textarea',
                      rows: 5,
                      value: ((j = l.otherProject) == null ? void 0 : j.description) || '',
                      onChange: (m) =>
                        c((h) => ({
                          ...h,
                ...
                r.jsxs('div', {
                  ...
                  children: [
                    ...
                    r.jsx('input', {
                      ...
                      className: 'sino-simple-form__input',
                      type: 'text',
                      value: ((N = l.otherProject) == null ? void 0 : N.timeline) || '',
                      onChange: (m) =>
                        c((h) => ({
                          ...h,
  ...
  Qm = ({ submissionId: l, t: c, onStartNew: a, selectedServiceLabels: w, formData: j }) => {
    const [C, N] = W.useState(!1),
    ...
    const z = W.useMemo(() => {
        ...
        let P = 0,
          I = 0;
        if (Q && Y) {
          const me = new Date(O.getTime() + 864e5).getTime() - O.getTime();
      ...
      K = async () => {
        try {
          (await navigator.clipboard.writeText(l), N(!0), setTimeout(() => N(!1), 2e3));
        } catch (O) {
                          ...
                          r.jsxs('div', {
                            ...
                            children: [
                              ...
                              r.jsxs('span', {
                                children: [
                                  (() => {
                                    const O = Qt.find((b) => b.code === j.country);
                                    return O ? O.name : j.country;
                                  })(),
                                  j.destCity && `, ${j.destCity}`,
                                ],
                              }),
                            ],
                          }),
...
function Ju(l, c, a, w) {
  if (Pe) {
    if (it && Gt) {
      const j = Math.round((Date.now() - it) / 1e3);
      (mi('step_completed', { step_id: l, step_index: a - 1, time_spent: j, total_steps: w }),
...
function np(l, c) {
  ...
  mi('form_submitted', {
    ...
    error_count: Object.values(Pe.problematicFields).reduce((N, m) => N + m, 0),
  });
...
const tp = () => {
    ...
    const { formData: l, setFormData: c, handleInputChange: a } = hm(),
      ...
      [Ti, pi] = W.useState(!1),
      Ei = W.useMemo(() => zm(), []),
      tt = W.useMemo(() => Im(l.country), [l.country]),
      rt = W.useRef(null),
      st = W.useRef(null),
      Li = W.useRef(null),
      ot = W.useRef(null),
        ...
        (y, L) => {
          ...
          !ne.valid && ne.error
            ...
            : (F((we) => {
              ...
              L && typeof L == 'string' && L.trim().length > 0 && ep(y, _e));
        },
        [_e]
      ),
      Dn = W.useMemo(
            ...
            children: [
              ...
              r.jsxs('div', {
                ...
                children: [
                  ...
                  _e === 'other' &&
                    r.jsx(Km, { formData: l, setFormData: c, t: k, stepLabel: `Step ${X + 1}` }),
                  _e === 'shippingRoute' &&
                    Hn &&
                    r.jsx(r.Fragment, {
                                ...
                                Z &&
                                  r.jsxs('div', {
                                    ...
                                    children: [
                                      ...
                                      r.jsx(Bm, { formData: l, setFormData: c, t: k }),
                                      r.jsxs('div', {
                                        className: 'sino-simple-form__field',
                                        children: [
                                          r.jsx('label', {
...
function ac(l) {
  ...
  c.innerHTML = '';
  const a = mm.createRoot(c);
  (a.render(
    r.jsx(W.StrictMode, {
      children: r.jsx('div', {
        className: 'sino-simple-form-root',
        children: r.jsx(fm, { children: r.jsx(tp, {}) }),
      }),
    })
  ),
    Kt.set(l, a),
...
const sp = { init: ac, destroy: rp, isInitialized: uc };
typeof window < 'u' &&
  ((window.SinoSimpleForm = sp),
