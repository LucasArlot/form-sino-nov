export const COUNTRIES = [
  ...
  { name: 'Macedonia, the Former Yugoslav Republic of', code: 'MK', flag: '🇲🇰', phonePrefix: '+389' },
  ...
  { name: 'South Georgia and the South Sandwich Islands', code: 'GS', flag: '🇬🇸', phonePrefix: '+500' },
