...
export function translate(locale: Locale, key: I18nKey, params?: Params) {
  ...
  const template = dict[key] ?? I18N_TEXT[DEFAULT_LOCALE][key] ?? (key as string);
...
const EN_TEXT: Record<string, string> = {
  ...
  validationCustomerType: 'Please choose whether you ship as an individual or a company',
  validationFirstName: 'Please enter your first name',
  validationLastName: 'Please enter your last name',
  validationShipperType: 'Please select your shipping experience',
...
const FR_TEXT: Record<string, string> = {
  ...
  validationCustomerType:
    'Veuillez préciser si vous expédiez en tant que particulier ou entreprise',
  validationFirstName: 'Veuillez renseigner votre prénom',
  validationLastName: 'Veuillez renseigner votre nom',
  validationShipperType: "Veuillez indiquer votre niveau d'expérience en expédition",
  validationCompanyName: 'Veuillez renseigner le nom de votre entreprise',
  ...
  submitDescription:
    'Cliquez sur le bouton Obtenir mon devis ci-dessous pour envoyer votre demande. Nous répondrons sous 24 heures.',
  ...
  personalHazardousHelp:
    'Cochez si vous expédiez des effets personnels ou des marchandises nécessitant une manipulation spéciale',
  ...
  rateValidityText:
    "Les tarifs indiqués sont valables jusqu'à la date d'expiration figurant sur chaque devis. Si vos marchandises ne sont pas prêtes à être enlevées à cette date, les tarifs peuvent être ajustés selon les conditions du marché.",
  ...
  additionalDetailsDescription:
    'Indiquez toute exigence particulière ou information supplémentaire',
  ...
  validationShipperType:
    "Veuillez sélectionner votre type d'expéditeur (particulier ou entreprise)",
};
...
const DE_TEXT: Record<string, string> = {
  ...
  validationDestinationCountry: 'Bitte wählen Sie ein Zielland aus',
  validationCustomerType: 'Bitte geben Sie an, ob Sie als Privatperson oder Unternehmen versenden',
  validationFirstName: 'Bitte geben Sie Ihren Vornamen ein',
  validationLastName: 'Bitte geben Sie Ihren Nachnamen ein',
  validationShipperType: 'Bitte wählen Sie Ihre Versanderfahrung aus',
  validationCompanyName: 'Bitte geben Sie den Namen Ihres Unternehmens ein',
  ...
  personalHazardousHelp:
    'Aktivieren Sie dies, wenn Sie persönliche Gegenstände oder Waren versenden, die eine besondere Behandlung erfordern',
  shipmentReadiness: 'Verfügbarkeit der Ware',
  shipmentTimingDescription:
    'Helfen Sie uns, Ihren Versandzeitplan zu planen und genaue Tarife zu liefern',
  ...
  rateValidityText:
    'Die angegebenen Tarife sind bis zum auf jedem Angebot angegebenen Ablaufdatum gültig. Wenn Ihre Waren bis zu diesem Datum nicht zur Abholung bereit sind, können die Tarife je nach aktuellen Marktbedingungen angepasst werden.',
...
const ES_TEXT: Record<string, string> = {
  ...
  pickupCityPostalDescription:
    'Proporcione la ciudad de recogida y el código postal para una recogida precisa',
  ...
  validationDestinationCountry: 'Seleccione un país de destino',
  validationCustomerType: 'Indique si envía como particular o empresa',
  validationFirstName: 'Ingrese su nombre',
  validationLastName: 'Ingrese su apellido',
  validationShipperType: 'Seleccione su experiencia de envío',
  validationCompanyName: 'Ingrese el nombre de su empresa',
...
const IT_TEXT: Record<string, string> = {
  ...
  validationDestinationCountry: 'Seleziona un paese di destinazione',
  validationCustomerType: 'Indica se spedisci come privato o azienda',
  validationFirstName: 'Inserisci il tuo nome',
  validationLastName: 'Inserisci il tuo cognome',
  validationShipperType: 'Seleziona la tua esperienza di spedizione',
  validationCompanyName: 'Inserisci il nome della tua azienda',
...
const NL_TEXT: Record<string, string> = {
  ...
  validationCustomerType: 'Geef aan of u verzendt als particulier of bedrijf',
  validationFirstName: 'Voer uw voornaam in',
  validationLastName: 'Voer uw achternaam in',
  validationShipperType: 'Selecteer uw verzendervaring',
...
const ZH_TEXT: Record<string, string> = {
  ...
  validationCustomerType: '请选择您是以个人还是公司身份发货',
  validationFirstName: '请输入您的名字',
  validationLastName: '请输入您的姓氏',
  validationShipperType: '请选择您的运输经验',
...
const AR_TEXT: Record<string, string> = {
  ...
  validationCustomerType: 'يرجى تحديد ما إذا كنت تشحن كفرد أم كشركة',
  validationFirstName: 'يرجى إدخال اسمك الأول',
  validationLastName: 'يرجى إدخال اسم العائلة',
  validationShipperType: 'يرجى اختيار خبرتك في الشحن',
  ...
  containerFeedback:
    'خيار رائع للأحجام الكبيرة أو خطوط المنتجات الكاملة أو عندما يكون لديك ما يكفي لملء حاوية',
  looseCargoFeedback:
    'مثالي للبضائع المختلطة والكميات الصغيرة إلى المتوسطة أو عند الحاجة إلى تغليف مرن',
  // Step 4 — what happens next
...
const PT_TEXT: Record<string, string> = {
  ...
  validationDestinationCountry: 'Selecione um país de destino',
  validationCustomerType: 'Informe se você envia como pessoa física ou empresa',
  validationFirstName: 'Informe seu nome',
  validationLastName: 'Informe seu sobrenome',
  validationShipperType: 'Selecione sua experiência em envios',
  validationCompanyName: 'Informe o nome da sua empresa',
  ...
  containerFeedback:
    'Ótima escolha para grandes volumes, linhas completas de produtos, ou quando você tem carga suficiente para encher um contêiner',
  looseCargoFeedback:
    'Ideal para cargas mistas, quantidades pequenas a médias, ou quando é necessário embalamento flexível',
  // Step 4 — what happens next
...
const TR_TEXT: Record<string, string> = {
  ...
  validationDestinationCountry: 'Lütfen bir varış ülkesini seçin',
  validationCustomerType: 'Lütfen bireysel mi yoksa şirket olarak mı gönderdiğinizi belirtin',
  validationFirstName: 'Lütfen adınızı girin',
  validationLastName: 'Lütfen soyadınızı girin',
  validationShipperType: 'Lütfen gönderim deneyiminizi seçin',
...
const RU_TEXT: Record<string, string> = {
  ...
  validationCustomerType: 'Укажите, отправляете ли вы как частное лицо или компания',
  validationFirstName: 'Введите имя',
  validationLastName: 'Введите фамилию',
  validationShipperType: 'Выберите свой опыт в логистике',
